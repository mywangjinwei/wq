		...
		<div class="container">
			<nav class="collapse navbar-collapse bs-navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="admin/sys-backup"><i
							class="fa fa-cogs"></i>网站设置</a></li>
				</ul>
			</nav>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-xs-3">
					<ul class="nav default-sidenav">
						<li><a href="admin/sys-backup"> <i
								class="fa fa-bar-chart-o"></i> 数据备份
						</a></li>
						<li><a href="admin/sys-admin-list"> <i
								class="fa fa-bar-chart-o"></i> 管理员列表
						</a></li>
						<li class="active"><a> <i class="fa fa-list-ul"></i>
								添加管理员
						</a></li>
						<li><a href="admin/field-list-1"> <i
								class="fa fa-bar-chart-o"></i> 题库列表
						</a></li>
					</ul>
				</div>
				<div class="col-xs-9">
